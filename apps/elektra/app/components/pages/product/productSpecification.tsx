...
export function ProductSpecification({
  ...
  return (
    <div>
      <Title className="uppercase" color={theme.other.color.tabTitle} order={6}>
        About Product
      </Title>
      <Title className="font-bold uppercase" size={'40px'} color={theme.other.color.primary} order={3}>
        {title}
      </Title>
      <form>
        <div>
          <Accordion
            styles={{
              ...
              control: {
                ...
                color: theme.other.color.lightPrimary,
                borderRadius: '6px',
                '&:hover': {
                  backgroundColor: theme.other.color.primary,
                  color: theme.other.color.lightPrimary,
