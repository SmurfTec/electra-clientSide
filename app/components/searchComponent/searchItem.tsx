import { ActionIcon, Badge, Center, Divider, Grid, Image, Paper, SelectItemProps, Stack, Text } from '@mantine/core';
...
export const AutoCompleteItem = forwardRef<HTMLDivElement, SearchItemProps>(
  ({ category, value, title, image, modal, ...rest }: SearchItemProps, ref) => (
    <div ref={ref} {...rest}>
      {value === '__show-more' && <Center className='text-black text-sm font-semibold'>Show more results</Center>}
      {value !== '__show-more' && (
        <>
          <Grid align="center">
